...
Elicitkit adopts the **Contributor Covenant, version 2.1** as its code of conduct:
<https://www.contributor-covenant.org/version/2/1/code_of_conduct/>

## In short

We pledge to make participation a harassment-free experience for everyone, regardless of background or identity. We expect: empathy and kindness, respect for differing views, graceful acceptance of constructive feedback, and focusing on what is best for the community. We do not tolerate harassment, insults, or other unprofessional conduct.

## Scope

Applies in all project spaces (repository, issues, pull requests, discussions) and when representing the project in public spaces.
